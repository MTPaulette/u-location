<template>
  <button id="dropdownPannierButton" data-dropdown-toggle="dropdownPannier" class="inline-flex items-center text-sm font-medium text-center focus:outline-none dark:hover:text-white dark:text-gray-400" type="button"> 
