    ...
    <div class="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <div class="w-full pl-3">
        <h4 class="w-5/6 truncate h-5 mb-1">
          <a href="" class="text-base">{{ product.title }}</a>
          <!-- <a href="" class="text-base md:text-sm">{{ product.name }}</a> -->
        </h4>
      
        <div class="h-10 md:h-8 overflow-hidden text-justify text-sm md:text-xs mb-2 text-gray-700 dark:text-gray-400"><p v-html="product.description" /></div>
