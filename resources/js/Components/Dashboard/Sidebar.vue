  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 sm:w-52 xl:w-64 h-screen pt-16 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div id="main-sidebar" class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium h-min-3/4 min-h-[60%]">
        ...
        <li v-if="user.role === 1">
          <button type="button" class="sidebar-item-btn" aria-controls="dropdown-advantage" data-collapse-toggle="dropdown-advantage">
          ...
          <ul id="dropdown-advantage" class="hidden py-2 space-y-2">
            <li>
              <Link href="/advantage" class="sidebar-item">Advantage</Link>
            </li>
            <li>
              <Link href="/category" class="sidebar-item">Category</Link>
            </li>
            <li>
              <Link href="/ingredient" class="sidebar-item">Ingredient</Link>
            </li>
            <li>
              <Link href="/theme" class="sidebar-item">Theme</Link>
            </li>
          </ul>
        </li>

        <li v-if="user.role === 1">
          <button type="button" class="sidebar-item-btn" aria-controls="dropdown-user" data-collapse-toggle="dropdown-user">
            <svg aria-hidden="true" class="sidebar-icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul id="dropdown-user" class="hidden py-2 space-y-2">
            <li>
              <Link href="/user" class="sidebar-item">Users List</Link>
            </li>
            <li>
              <Link href="/user/create" class="sidebar-item">New User</Link>
            </li>
            <li>
              <Link href="/profile" class="sidebar-item">Profile</Link>
            </li>
          </ul>
        </li>
        <li v-else>
        ...
        <li>
          <button type="button" class="sidebar-item-btn" aria-controls="dropdown-ecommerce" data-collapse-toggle="dropdown-ecommerce">
          ...
          <ul id="dropdown-ecommerce" class="hidden py-2 space-y-2">
            <li>
              <Link href="/product" class="sidebar-item">Products</Link>
            </li>
            <li>
        ...
        <li v-if="user.role === 1">
          <button type="button" class="sidebar-item-btn" aria-controls="dropdown-product" data-collapse-toggle="dropdown-product">
          ...
          <ul id="dropdown-product" class="hidden py-2 space-y-2">
            <li>
              <Link :href="route('dashboard.product.index')" class="sidebar-item">Products List</Link>
            </li>
            <li>
              <Link :href="route('dashboard.product.create')" class="sidebar-item">New Product</Link>
            </li>
          </ul>
        </li>
        
        <li v-if="user.role === 1">
          <button type="button" class="sidebar-item-btn" aria-controls="dropdown-article" data-collapse-toggle="dropdown-article">
          ...
          <ul id="dropdown-article" class="hidden py-2 space-y-2">
            <li>
              <Link :href="route('dashboard.post.index')" class="sidebar-item">Posts List</Link>
            </li>
            <!-- :href="route('product.image.destroy', {product: product.id, image: image.id})" -->
            <li>
              <Link :href="route('dashboard.post.create')" class="sidebar-item">New post</Link>
            </li>
          </ul>
        </li>
