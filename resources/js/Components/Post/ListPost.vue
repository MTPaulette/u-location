      ...
      <table class="table-auto border">
        ...
        <tbody>
          <tr v-for="post in posts.data" :key="post.id" class="bg-white border-b dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <!-- <td class="px-5 py-3.5 capitalize font-medium text-gray-900 whitespace-nowrap dark:text-white"> -->
            <td class="px-5 py-3.5 capitalize font-medium text-gray-900 dark:text-white">
              <span class="font-bold">{{ post.title }}</span>
              <br /><br /><span class="underline font-semibold">category:</span> <br />{{ post.theme }}
            ...
            <td class="px-5 py-3.5 relative text-justify">
              ...
              <div id="dropdownPostActions" class="z-50  bg-white divide-y divide-gray-100 rounded-lg shadow w-32 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownPostActionsButton">
                  ...
                  <li>
                    <Link :href="route('dashboard.post.update', {post: post.id})" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-600 dark:hover:text-white">
                      block
                    </Link>
                  </li>
                  <li>
                    <Link :href="route('dashboard.post.destroy', {post: post.id})" class="block px-4 py-2 hover:bg-red-100 dark:hover:bg-red-600 dark:hover:text-white">
                      delete
                    </Link>
                  </li>
                </ul>
