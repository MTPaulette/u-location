<template>
  ...
  <div class="flex justify-around items-center h-[100px] w-full shadow shadow-sheet-50 mb-1 text-sheet-100 font-extrabold text-[10px] uppercase">
    ...
    <div class="flex flex-col items-center justify-center">
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 h-8 lg:w-10 lg:h-10" viewBox="0 0 16 16">
          <path d="M5.52.359A.5.5 0 0 1 6 0h4a.5.5 0 0 1 .474.658L8.694 6H12.5a.5.5 0 0 1 .395.807l-7 9a.5.5 0 0 1-.873-.454L6.823 9.5H3.5a.5.5 0 0 1-.48-.641l2.5-8.5zM6.374 1 4.168 8.5H7.5a.5.5 0 0 1 .478.647L6.78 13.04 11.478 7H8a.5.5 0 0 1-.474-.658L9.306 1H6.374z" />
        </svg>
      </div>
      <p class="mt-2 font-normal lg:font-bold text-sheet-300 dark:text-sheet-50 text-center">
        high quality
      </p>
    </div>

    <div>
      <img src="./../../images/naturel_white.png" class="h-[90px] w-[120px]" />
    ...
    <div class="flex flex-col items-center justify-center">
      ...
      <p class="mt-2 font-bold text-sheet-300 dark:text-sheet-50 text-center">
        secure payment
      </p>
    </div>
    <div class="flex flex-col items-center justify-center">
