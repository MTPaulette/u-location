<template>
  <div class="relative overflow-x-auto">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 my-5">
      ...
      <tbody>
        <tr v-for="user in users.data" :key="user.id" class="bg-white border-b dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
          <td class="w-4 p-4">
            <div class="flex items-center">
          ...
          <th scope="row" class="flex items-center px-6 py-2.5 text-gray-900 whitespace-nowrap dark:text-white">
            ...
            <div class="pl-3">
              <Link :href="`user/${user.id}`" class="text-base font-semibold hover:text-mango">{{ user.name }}</Link>
