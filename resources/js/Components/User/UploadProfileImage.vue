<template>
  <div class="flex items-center md:block">
    ...
    <div v-else class="relative w-28 max-h-28">
      <Link :href="route('userImage.destroy', {userImage: user.id})" method="DELETE" as="btn" class="absolute text-white hover:text-red-500 top-0 right-0 pt-1 pl-1 bg-gray-700 rounded-full">
    ...
    <div class="pl-3 md:pl-0 mt-0 md:mt-4">
