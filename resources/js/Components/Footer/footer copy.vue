    ...
    <div class="mx-auto w-full p-4 sm:p-6">
      ...
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0 w-full md:w-[350px]">
          <a href="https://flowbite.com/" class="flex items-center ">
            ...
            <div>
              <span class="self-center text-3xl font-semibold whitespace-nowrap text-gray-300">Agrimax</span>
            </div>
          </a>
        </div>
        <div class="grid grid-cols-2 gap-3 sm:gap-6 sm:grid-cols-6 md:grid-cols-7">
          ...
          <div>
            <h2 class="mb-6 text-base font-semibold text-gray-300">Pages</h2>
            <ul class="">
              <li v-for="(pageLink, i) in pagesLinks" :key="i" ref="pagesLinksRef" class="mb-2 text-sm text-gray-500 hover:text-blue-400 dark:hover:text-gray-300">
          ...
          <div>
            <h2 class="mb-6 text-base font-semibold text-gray-300">Legal</h2>
            <ul class="">
              ...
              <li v-for="(legalLink, i) in legalLinks" :key="i" ref="legalLinksRef" class="mb-2 text-sm text-gray-500 hover:text-blue-400 dark:hover:text-gray-300">
                <a :href="legalLink[0]">{{ legalLink[1] }}</a>
              </li>
            </ul>
          </div>
          <div class="col-span-2 md:col-span-3">
            <h2 class="mb-6 text-base font-semibold text-gray-300">Articles recents</h2>
            <!-- <ul class="list-[square] pl-5 "> -->
            <ul class="">
              <li v-for="(post, i) in posts" :key="i" ref="postsRef" class="mb-2 text-sm text-gray-500 hover:text-blue-400 dark:hover:text-gray-300">
                <a :href="post[0]">
                  <p>{{ post[1] }}</p>
                </a>
              </li>
          ...
          <div class="col-span-2">
            <h2 class="mb-6 text-base font-semibold text-gray-300">Quelques produits</h2>
            <div class="flex flex-wrap ">
              <div v-for="(product, i) in products" :key="i" ref="productsRef" class="mb-2 text-sm text-gray-500 hover:text-blue-400 dark:hover:text-gray-300">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <!-- <a href="#" class="text-gray-500 hover:text-gray-400 dark:hover:text-white"> -->
          <a href="#" class="text-gray-500 hover:text-blue-400 dark:hover:text-white">
