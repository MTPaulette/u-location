        ...
        >
          <div class="flex justify-between items-center px-1">
            ...
            <div class="ml-1 flex items-center">
              <!-- edit -->
              <span class="btn-default px-2 py-1.5 text-xs rounded-lg" @click="editForm(theme)">
              ...
              <span class="ml-1.5 btn-danger px-2 py-1 text-xs rounded-lg" @click="confirmDelete(theme.id);">
          ...
          <!-- confirmDelete -->
          <div v-if="confirm == theme.id" class="w-full flex p-4 mt-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
            ...
            <div>
              ...
              <div class="flex gap-2 mt-1.5">
                <div @click="$emit('delete', theme.id);">
...
const confirmDelete = (theme_id) => {
  edit.value = null
  confirm.value = theme_id
}
</script>
