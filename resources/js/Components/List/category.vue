        ...
        >
          <div class="flex justify-between items-center px-1">
            ...
            <div class="ml-1 flex items-center">
              <!-- edit -->
              <span class="btn-default px-2 py-1.5 text-xs rounded-lg" @click="editForm(category)">
              ...
              <!-- delete -->
              <!-- <span class="ml-1.5 btn-danger px-2 py-1 text-xs rounded-lg" @click="$emit('delete', category.id);"> -->
              <span class="ml-1.5 btn-danger px-2 py-1 text-xs rounded-lg" @click="confirmDelete(category.id);">
          ...
          <!-- editForm -->
          <div v-if="edit == category.id">
            <form class="relative w-full" @submit.prevent="update(category)">
              <textarea v-model="form.category" rows="2" class="text-area mb-2" placeholder="new category..." />
              <div class="flex gap-1">
                <Button type="submit" label="update" rounded success extrasmall :disabled="!form.category" />
                <div @click="edit = null">
          ...
          <!-- confirmDelete -->
          <div v-if="confirm == category.id" class="w-full flex p-4 mt-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
            ...
            <div>
              ...
              <div class="flex gap-2 mt-1.5">
                <div @click="$emit('delete', category.id);">
