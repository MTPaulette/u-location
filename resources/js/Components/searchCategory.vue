  ...
  <form>
    <div class="flex">
      ...
      <div class="relative w-full">
        <input id="search-dropdown" type="search" class="block p-4 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-md border-l-gray-100 border-l-2 border border-gray-300 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-green-500" placeholder="Search Product here ..." required />
