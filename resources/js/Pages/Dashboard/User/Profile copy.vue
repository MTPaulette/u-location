  ...
  <DashboardLayout>
    ...
    <div class="w-full h-auto">
        ...
        <div class="block w-full px-5 py-5 h-auto md:col-span-2 lg:col-span-1 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center md:block">
            ...
            <div class="pl-3 md:pl-0">
              <div class="text-base font-semibold mb-0.5 dark:text-white">{{ user.firstname }} <span class="uppercase">{{ user.lastname }}</span></div>
              <div class="font-normal text-gray-500 mb-4">{{ user.email }}</div>
              <div @click="updateProfilePic">
                <Button label="change profile" hasicon rounded btn base>
          ...
          <form class="flex flex-col justify-between w-full h-auto">
            <div class="grid gap-2 sm:gap-6 grid-cols-2">
              <div>
                ...
                <input id="first_name" type="text" class="input" :placeholder="user.firstname" required />
              </div>
              <div>
                <label for="last_name" class="label">Last name</label>
                <input id="last_name" type="text" class="input" :placeholder="user.lastname" required />
              </div>
              <div>
                <label for="phone" class="label">Phone number</label>
                <input id="phone" type="tel" class="input" :placeholder="user.telephone ? user.telephone : '123-45-678'" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required />
              </div>
              <div>
              ...
              <div>
                <label for="cities" class="label">City</label>
                <select id="cities" class="input">
              ...
              <div>
                ...
                <input id="address" type="text" class="input" placeholder="John" required />
              </div>
            </div>
      ...
      <div class="my-4 md:my-5 lg:my-12 md:col-span-2 w-full px-5 py-5 h-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <form class="flex flex-col justify-between w-full h-auto" @submit.prevent="login">
          <div class="grid gap-2 sm:gap-6 grid-cols-2">
            <div>
              <label for="current_password" class="label">Current Password</label>
              <input id="current_password" type="password" class="input" placeholder="•••••••••" required />
            </div> 
            <div>
              <label for="new_password" class="label">New Password</label>
              <input id="new_password" type="password" class="input" placeholder="•••••••••" required />
            </div> 
            <div>
              <label for="confirm_password" class="label">Confirm password</label>
              <input id="confirm_password" type="password" class="input" placeholder="•••••••••" required />
            </div>
          </div>
          ...
          <div>
            <Button type="submit" label="save" rounded  btn small>mmm</Button>
