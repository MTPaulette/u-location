<template>
  <DashboardLayout>
    <div class="sm:flex sm:flex-row-reverse sm:justify-between sm:items-center h-auto mt-5 mb-3 mx-0 sm:mx-5">
      <div>
        <breadcrumb link1="dashboard" link2="ingredients" />
      </div>
      <div>
        <myTitle title="Ingredients" />
      </div>
    </div>
        ...
        <div class="col-span-2 flex flex-col items-center justify-center">
          <div class="p-3 mb-4 rounded-lg bg-gray-50 dark:bg-gray-700">
            <p class="text-sm text-gray-500 dark:text-gray-400">
              ...
              You can also use the trash icon to delete some ingredient.
            </p>
          </div>
...
const addNew = () => {
  form.post('/ingredient')
  form.reset('ingredient')
}

const deleteItem = (i) => {
  router.delete(`/ingredient/${i}`)
}
</script>
